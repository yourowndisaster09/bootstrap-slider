...
describe("Touch Capable Tests", function() {
  ...
  beforeEach(function() {
    ...
    // Calculate and store the 'clientX' for each tick in the slider
		// tickOffsets = sliderInst.ticks.map(function (tick) {
		// 	return tick.offsetLeft + sliderInst.sliderElem.offsetLeft;
		// });
  });
  ...
  // 0 1 2 3 4
  // 0 3 5 7 10
  it("should slide the handle from 5 to 3", function(done) {
